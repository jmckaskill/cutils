...
struct async_class {
	...
	int(*add_socket)(const async_class **vt, async_socket *s, int fd, async_socket_cb cb);
	int(*add_listener)(const async_class **vt, async_listener *ln, int fd, async_listen_cb cb);
	...
	ssize_t(*connect)(const async_class **vt, async_socket *s, const struct sockaddr *sa, socklen_t len, const char *initial_msg, size_t mlen);
	ssize_t(*read)(const async_class **vt, async_socket *s, char *buf, size_t len);
	ssize_t(*write)(const async_class **vt, async_socket *s, const char *buf, size_t len);
